          ...
          <div className="">
            <div className="grid grid-cols-1 gap-4">
              ...
              {assignments.map((assignment) => (
                <div key={assignment._id} className={`mx-5 text-wrap font-bold text-xl p-2 rounded-lg shadow-md ${isHovered ? 'bg-gray-900' : 'bg-gray-800'}`} style={{ ...cardStyle, ...(isHovered && cardHoverStyle), color: '#28c244' }}
